...
bench init frappe-bench --frappe-branch version-115 --python python3.11
    cd frappe-bench/
    bench start
    
### STEP 14 create a site in frappe bench 
    
    bench new-site demoApplication
...
### STEP 15 install ERPNext latest version in bench & site
    ...
    bench --site demoApplication install-app erpnext
